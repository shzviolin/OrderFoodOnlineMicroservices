...
namespace OrderFoodOnlineMicroservices.Services.ShoppingCartAPI.Extensions
{
    public static class WebApplicationBuilderExtensions
    {
        public static WebApplicationBuilder AddAppAuthentiocation(this WebApplicationBuilder builder)
        {
